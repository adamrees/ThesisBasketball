...
#ENTER TEAM AND PLAYER 


gameData <- read.csv("~/Desktop/Thesis/ThesisBasketball/totalJazzGames.csv")
gameData <- gameData %>% filter(gameData$point != 1, gameData$shootingTeam != "UTA")

gameData <- gameData %>% filter(gameData$shootingTeam != "UTA")
gameData$playerDefending <- NULL
defendingPlayer <- "5197"
