...
#png(file="saving_plot2.png",width=500, height=360)
image.plot(grid.a, grid.b, noZeroFit, col = colorTable, main="Phoenix Suns Shots", sub="2019-2020 Season", xlab="Baseline", ylab="Sideline")
#dev.off()
