...
GameSchedule <-read.csv("~/Desktop/nba-full-schedule-2019-2020.csv")
...
gamesData <- GameSchedule %>% filter((home_team == "PHX" | away_team == "PHX") & (home_team == "LAL" | away_team == "LAL"))
gamesData
...
"https://sports.yahoo.com/nba/los-angeles-lakers-phoenix-14-2019111224/?section=gamestream"
...
#shotsNoFT$pointsPerShot[i] <- shotsNoFT$MakeMiss[i]*currentGame$shotType[i]
...
```
Error in `$<-.data.frame`(`*tmp*`, pointsPerShot, value = c(2, 2, 3, 2, : replacement has 172 rows, data has 168
...
url <- getURL("https://sports.yahoo.com/nba/utah-jazz-san-antonio-spurs-2020012924/?section=gamestream")
