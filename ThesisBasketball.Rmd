...
Currently: getting NAs on the enter player and leave player
```{r}
...
for(i in 1:numShots){
  ...
  while(!is.na(subs[[1]][subsCounter + 1]) &&
    ...
    leavePlayer <- as.numeric(substr(data, subs[[1]][subsCounter] + 73, subs[[1]][subsCounter] + 76))
...
for(j in 1:53){
enterPlayer[i] <- as.numeric(substr(data, subs[[1]][subsCounter] + 51, subs[[1]][subsCounter] + 54))
    leavePlayer[i] <- as.numeric(substr(data, subs[[1]][subsCounter] + 73, subs[[1]][subsCounter] + 76))
    subsCounter <- subsCounter + 1
}
