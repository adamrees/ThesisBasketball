...
covGen <- function(xLoc, yLoc, lam) {
  ...
  Sigma <- data_frame(S11, S12, S21, S22)
  return(Sigma)
}
...
finalFunction <- function(S11, S12, S21, S22, y, sig){
...
#c <- finalFunction(a$S11, a$S12, a$S21, a$S22, b$tempY, b$tempSig)
